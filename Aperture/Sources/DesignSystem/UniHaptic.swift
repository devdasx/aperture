...
enum UniHaptic: Hashable, Sendable {
    ...
    /// `Aperture/Resources/Haptics/*.ahap`. Add a case here AND ship
    ...
    enum Signature: String, Hashable, Sendable, CaseIterable {
        ...
        case pinSealed
        case transactionSigned    // Resources/Haptics/transactionSigned.ahap
        case transactionConfirmed // Resources/Haptics/transactionConfirmed.ahap
