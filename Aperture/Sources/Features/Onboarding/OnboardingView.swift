...
struct OnboardingView: View {
    ...
    // they propagate cleanly through `.apertureEnvironment()` and preserve any
    ...
    /// persisted in the final handoff step, which would otherwise flip the
    /// gate to the main tabs and tear the cover down mid-flow). Kept in sync
    /// with `activeFlow` (2026-06-20 fix).
    ...
    var body: some View {
        ...
        .fullScreenCover(item: $activeFlow, onDismiss: {
            ...
            Group {
                ...
                case .importWallet:
                    ...
                    // .id key on layout direction, .apertureEnvironment
                    // for theme/locale.
                    ImportWalletFlow(
                        ...
                        onCompleted: { _ in
                            ...
                            // and dismiss. Main shell observes persisted
        ...
        // the new wallet in the final handoff step flips the gate to the main
        // tabs and tears this cover down before the flow can dismiss itself.
        // Syncs immediately, so finishing the flow
        ...
        // `.apertureEnvironment()` re-applies theme/locale; opaque-white
