...
enum MarketChartRange: String, CaseIterable, Identifiable {
    ...
    var deltaLabel: String {
        switch self {
        case .oneHour: return String.apertureLocalized("past hour")
        case .oneDay: return String.apertureLocalized("today")
        case .oneWeek: return String.apertureLocalized("past week")
        case .oneMonth: return String.apertureLocalized("past month")
        case .oneYear: return String.apertureLocalized("past year")
        }
    }
...
enum MarketChartSampling {
    ...
    static func clip(
        ...
        // P3-012: no force-unwrap after empty guard — use optional last.
        guard let end = sorted.last?.timestamp else { return [] }
