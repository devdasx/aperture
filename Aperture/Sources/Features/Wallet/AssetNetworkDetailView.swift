...
struct AssetNetworkDetailView: View {
    ...
    /// the $0.20-USD dust gate (2026-06-19 user direction). Loaded async
    ...
    var body: some View {
        ...
        .task(id: identity.symbol) {
            // USD prices for the $0.20-USD dust gate — engine-cached,
    ...
    /// `filteredTransactions` with sub-$0.20-USD dust removed (2026-06-19
