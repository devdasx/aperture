...
struct AssetDetailView: View {
    ...
    /// $0.20-USD dust gate (2026-06-19 user direction). Loaded async after
    ...
    var body: some View {
        ...
        .sheet(isPresented: $isShowingFilter) {
            ...
            // `.apertureEnvironment()` so theme + locale propagate.
    ...
    /// This asset's filtered transactions with sub-$0.20-USD dust removed
