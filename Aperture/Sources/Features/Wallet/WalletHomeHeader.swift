...
struct WalletHomeHeader: View {
    ...
    /// When `true`, render the balance as `••••` until tapped.
    /// **M-004:** Toggled by the eye control on `BalanceCardView` (not
    /// Settings → Preferences). Preference key is still GRDB-backed.
