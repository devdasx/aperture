...
///
/// De-swapped 2026-06-23: this logic used to live in `SwapEVMSigner` /
/// `SwapEVMABI` / `SwapAllowance` under the removed swap feature; the dApp
/// browser owns its own copy now, with no swap dependency.
///
