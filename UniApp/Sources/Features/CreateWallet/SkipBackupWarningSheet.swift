...
/// Native pushed version used inside the create-wallet NavigationStack.
/// The initial Create/Import presentation is the only slide-up; this keeps
/// the skip decision in the same back-stack as the rest of onboarding.
struct SkipBackupWarningScreen: View {
    let onBackUpNow: () -> Void
    let onSkipAnyway: () -> Void
